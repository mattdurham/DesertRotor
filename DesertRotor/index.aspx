...
<body>
    ...
    <div id="custom-bootstrap-menu" class="navbar navbar-default " role="navigation">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand" href="#">Desert Rotor LLC</a>
    ...
    <div class="container">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center">
            <div id="banner">
                <h1>
                    Desert Rotor <strong>Registration Form</strong> for UAV Enthusiasts</h1>
                <h5>
                    <strong>Alexander S. Olson</strong></h5>
            </div>
        </div>
